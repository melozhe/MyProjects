...
// It is now a shallow copy, which means it copy the pointers not what they 
// point, and this can be problematic, because now there are two list pointing 
// to the same chunk of memory and the data will change if any list alters the data 
