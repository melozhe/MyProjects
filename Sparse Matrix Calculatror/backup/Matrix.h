...
// size()
// Return the size of the square Matrix M
int size(Matrix M);

// NNZ()
// Return the number of non-zero elemnets in M
int NNZ(Matrix M);

// equals()
// Return true (1) if matrics A and B are equal, false (0) otherwise
...
// changeEntry()
// Change the ith row, jth column of M to the value x
