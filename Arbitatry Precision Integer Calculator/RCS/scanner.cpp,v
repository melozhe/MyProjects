...
1.21
date	2019.04.05.21.36.05;	author -;	state -;
branches;
next	1.20;

1.20
date	2019.04.05.21.30.00;	author -;	state -;
branches;
next	1.19;
...
@
text
@// $Id: scanner.cpp,v 1.20 2019-04-05 14:30:00-07 - - $
...
d29 1
a29 1
   return {tsymbol::OPERATOR, string (get())};
@
