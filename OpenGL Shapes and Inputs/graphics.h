...
class object {
   ...
   public:
      ...
      //void selected(bool selected_){is_selected = selected_;};
      //bool selected(){ return is_selected;};
      void draw(size_t num, bool is_selected = false);
...
class window {
   ...
   private:
      ...
      static void move_selected_obj(int dx, int dy);
   ...
   public:
      ...
      static void setbordercolor (const rgbcolor& color) { bordercolor = color; }
      static void setborderwidth (GLfloat borderwidth_) {borderwidth = borderwidth_;}
